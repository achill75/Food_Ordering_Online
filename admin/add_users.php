...
if (isset($_POST['submit'])) {
    if (
        ...
        if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) // Validate email address
        {
            ...
            $mql = "INSERT INTO users(username,f_name,l_name,email,phone,password,address,CreatedBy) VALUES('" . $_POST['uname'] . "','" . $_POST['fname'] . "','" . $_POST['lname'] . "','" . $_POST['email'] . "','" . $_POST['phone'] . "','" . md5($_POST['password']) . "','" . $_POST['address'] . "','" . $CreatedBy . "')";
            mysqli_query($db, $mql);
