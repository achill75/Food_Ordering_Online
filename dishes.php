                    ...
                    <div class="widget widget-cart">
                                ...
                                ?>
                                    ...
                                    <div class="title-row">
                                        <?php echo $item["title"]; ?><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>">
                                            <i class="fa fa-trash pull-right" style="margin-top: 22px;"></i></a>
                                    </div>

                                    <div class="form-group row no-gutter" style="display: flex; align-items: center;">
                                        <!-- Harga -->
                        ...
                        <div class="widget-body">
                            <div class="price-wrap text-xs-center">
                                ...
                                <?php } else { ?>
                                    <button class="btn theme-btn btn-lg" disabled>Checkout</button>
                                    <p class="text-danger" style="margin-top:10px;">Keranjang Anda kosong</p>
                                <?php } ?>
                            </div>
                        </div>
